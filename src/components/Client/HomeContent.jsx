        ...
        <EditorLayout>
            ...
            >
                <div className={styles.line}>
                    <span className={styles.comment}>// Full-Stack Developer & Blockchain Specialist</span>
                </div>
                <div className={styles.line}>
                    <span className={styles.comment}>// Based in India, working globally (US, EU)</span>
                </div>
                ...
                <div className={styles.line}>
                    ...
                    <span className={styles.className}><Typewriter text="Vasanthakumar C" delay={100} /></span>
                    <span className={styles.tag}>&lt;/h1&gt;</span>
                </div>
                <div className={styles.line}>
                    <span className={styles.indent3}>&lt;<span className={styles.tag}>h2</span>&gt;</span>
                    <span className={styles.className}><Typewriter text="Freelance Software & Blockchain Developer" delay={50} /></span>
                ...
                <div className={styles.line}>
                    ...
                    <Link href="/project" className={styles.button}>View Projects</Link>
